...
?>
		...
		<div class="container">
			<section>
				<h2 class="text-center my-4">Por que o Check-up de Adoção é Essencial?</h2>
					<div class="row column-gap-3 row-gap- justify-content-center">

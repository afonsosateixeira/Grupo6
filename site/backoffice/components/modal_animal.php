<div class="modal fade" id="formModalanimal">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <form action="components/action_animal.php" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                <label class="form-label fw-bold">Nome do Animal <span class="text-danger">*</span></label>
                                <input type="text" name="nome_animal" class="form-control" placeholder="Ex: Boby"
                                    value="<?= $aniEdit ? $aniEdit['name'] : ''; ?>" required maxlength="50">
                            </div>

                            <div class="mb-3">
                                <label class="form-label fw-bold">Escolha a Espécie <span class="text-danger">*</span></label>

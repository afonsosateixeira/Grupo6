        ...
        <section class="container text-center">
            <section class="py-4">
                ...
                <div class="d-flex flex-row flex-wrap justify-content-center gap-4 my-4">
                    <div class="box-pink">
                        <img src="assets/img/home_yara.jpg" class="rounded-top-4" alt="Foto da Yara">
                        <p class="pt-2 pb-3">Yara</p>
                    </div>

                    <div class="box-blue">
                        <img src="assets/img/home_zeus.webp" class="rounded-top-4" alt="Foto do Zeus">
                        <p class="pt-2 pb-3">Zeus</p>
                    </div>

                    <div class="box-blue">
                        <img src="assets/img/home_mike.avif" class="rounded-top-4" alt="Foto do Mike">
